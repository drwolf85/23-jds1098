...
for county in [17105, 17113, 31135, 38075, 39149, 48189]:
    ...
    f = open(f"../res/rnn_bi_results_{county}.txt", "w")
    ...
    for i in range(50):
        ...
        net = tf.keras.Sequential([
            tf.keras.layers.SimpleRNN(256, input_shape = (twlen - 2, 8), unroll = True),
        ...
        tic = time.time()
        net.fit(bindata[:, 0:(twlen - 2), :], inddata[:, twlen - 2, :], 
        ...
        f = open(f"../res/rnn_bi_results_{county}.txt", "a")
